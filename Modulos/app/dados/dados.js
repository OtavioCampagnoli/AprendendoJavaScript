/*
    Usamos um array (colecao_signos) nesse exemplo, pois não estamos consumindo os dados de uma API ou diretamente de um banco de dados.
*/
let colecao_signos = [
...
export default colecao_signos; // default significa que vamos exportar colecao_signos como o recurso padrão do arquivo
