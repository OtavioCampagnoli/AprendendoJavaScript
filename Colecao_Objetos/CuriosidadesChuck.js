var curiosidades_chuck_norris = [
    ...
    { titulo: "Fórmula para maratonar séries", conteudo: "Chuck Norris pode assistir um episódio de 60 minutos em 27 segundos." },
    { titulo: "Suicida que não morre", conteudo: "Chuck Norris foi homem-bomba 34 vezes." },
    { titulo: "Olhos que tudo vêem", conteudo: "Chuck Norris já viu o homem invisível." },
    { titulo: "Manipulando o tempo", conteudo: "Chuck Norris não usa relógio. Ele decide que horas são." },
    { titulo: "Praticando esportes radicais", conteudo: "Chuck Norris faz bungee jump sem cordas." },
...
console.log("CURIOSIDADES SOBRE O CHUCK NORRIS");
console.log("\nTítulo: " + titulo_curiosidade);
console.log("\nConteúdo: " + conteudo_curiosidade);